...
class NuScenesDataset(PointCloudDataset):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.use_cbgs = kwargs.get('use_cbgs', True)
    ...
    def load_infos(self, info_path):
        ...
        if not self.test_mode:  # if training
            if self.use_cbgs:
                ...
                # frac == 0.1 (10 classes in total)
                frac = 1.0 / len(self._class_names)
                # ratio: the ratio for random sampling, to evenly sample among classes
