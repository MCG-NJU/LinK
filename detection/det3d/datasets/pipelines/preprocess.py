...
class Preprocess(object):
    def __init__(self, cfg=None, **kwargs):
        ...
        if self.mode == "train":
            ...
            if "db_sampler" in cfg and cfg.db_sampler.enable:
            ...
            self.tt_rotation = cfg.get("tt_rotation", 0)
    ...
    def __call__(self, res, info):
        ...
        if res["type"] in ["WaymoDataset"]:
            ...
            points = res["lidar"]["combined"] # combined = cat(coords, time), shaped Nx5
        else:
        ...
        if self.mode == "train" and not self.no_augmentation:
            ...
            # self.min_points_in_gt defaults to -1
        ...
        if self.mode == "val" and self.tt_rotation != 0:
            points[:, :3] = box_np_ops.rotation_points_single_angle(
                points[:, :3], self.tt_rotation, axis=2
            )
            # print(f"rotate {self.tt_rotation}")
