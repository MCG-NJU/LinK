...
def train_detector(model, dataset, cfg, distributed=False, validate=False, logger=None):
    ...
    if cfg.lr_config.type == "one_cycle":
        ...
        #------- To visualize lr, uncoment below -------#
        # from torch.utils.tensorboard import SummaryWriter
        # writer = SummaryWriter('/data1/dingxiang/cp_from_10/work_dirs/debug/tf_logs')
        # for i in range(0, total_steps, 40):
        #     lr_scheduler.step(i)
        #     writer.add_scalar('lr', lr_scheduler.optimizer.lr, i//4)
